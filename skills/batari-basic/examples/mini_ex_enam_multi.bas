   ;***************************************************************
   ;
   ;  ENAM1 With Multicolored Sprite Example
   ;
...
__Start_Restart
   ...
   ;***************************************************************
   ;
   ;  Sets starting position of player1 and missile1.
   ;
   player1x = 62 : player1y = 50 : missile1x = 92
...
__Main_Loop
   ...
   ;***************************************************************
   ;
   ;  Turns on missile1 strip and sets width.
   ;
   ENAM1{1} = 1 : NUSIZ1= $20
