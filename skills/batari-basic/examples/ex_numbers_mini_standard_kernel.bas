   ...
   ;  Instructions:
   ;  
   ;  Move the joystick to change the number.
   ;  
   ;```````````````````````````````````````````````````````````````
   ;
...
__Main_Loop
   ...
   ;***************************************************************
   ;
   ;  Number change section (joystick changes number).
   ;
   ;```````````````````````````````````````````````````````````````
   ;  Clears the joystick restrainer bit if joystick is not moved.
   ;
   if !joy0up && !joy0down && !joy0left && !joy0right then _Bit6_Joy0_Restrainer{6} = 0 : goto __Skip_Joystick_Number_Change

   ;```````````````````````````````````````````````````````````````
   ;  Skips this section if joystick already moved.
   ;
   if _Bit6_Joy0_Restrainer{6} then goto __Skip_Joystick_Number_Change
   ...
   ;```````````````````````````````````````````````````````````````
   ;  Changes display number based on joystick movement.
   ;
   if joy0up || joy0left then _DisplayNumber = _DisplayNumber - 1 : if _DisplayNumber > 250 then _DisplayNumber = 9

   if joy0down || joy0right then  _DisplayNumber = _DisplayNumber + 1 : if _DisplayNumber > 9 then _DisplayNumber = 0
